...
public class UserProfileController {
    ...
    @PostMapping("/profile")
    public String saveUserProfile(@RequestBody @Validated UserProfileRequest userProfileRequest,
    ...
    @PutMapping("/profile")
    public String updateUserProfile(@RequestBody @Validated UserProfileRequest userProfileRequest,
                                  @CurrentUser UserPrincipal currentUser) {
