...
@Schema(description = "멘토 프로필 리스트 조회 시 반환하는 DTO")
@Getter @Builder
@AllArgsConstructor
@NoArgsConstructor
public class MentorProfileListResponse {
    ...
    @Schema(description = "현재 직무", example = "프론트엔드 개발자")
    private String job;

    @Schema(description = "직무 연차", example = "1")
    private Long workYear;

    @Schema(description = "닉네임", example = "김멘토")
